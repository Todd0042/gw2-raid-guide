#!/usr/bin/env python3
"""
gen_icebrooddata.py  —  regenerate src/data/IcebroodData.cpp from IcebroodStrikes.json.

Run from the project root:
    python3 gen_icebrooddata.py
"""
import json
import sys
...
SRC     = ROOT / 'IcebroodStrikes.json'
OUT_CPP = ROOT / 'src' / 'data' / 'IcebroodData.cpp'
...
def main() -> None:
    ...
    if not isinstance(data, list):
        print('ERROR: IcebroodStrikes.json must be a JSON array at the top level.')
        sys.exit(1)
